...
After some exploratory data analysis, an interesting thing found in regards to the first question are the box plots relating the population and site a possum is from to the same possum's total length. As shown in the box plots for populations, there is not much of a difference between the different populations; however, some of the box plots for site a noticeably different, like sites two and four. (Additionally, a summary for the data is given in Figure 11. This suggests that using *site* may be more useful.
