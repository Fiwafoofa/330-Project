...
Since the linear model we are going to be using to fit explore this data can be used to answer both questions we conduct the exploratory data analysis for both questions here.
